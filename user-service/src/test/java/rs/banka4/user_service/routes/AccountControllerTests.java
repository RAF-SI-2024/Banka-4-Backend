...
public class AccountControllerTests {
    ...
    void testGetAll() throws Exception {
        ...
        Mockito.when(accountService.getAll(any(), any(), any(), any(), any(PageRequest.class)))
    ...
    void testGetAccount() throws Exception {
        ...
        AccountDto accountDto = AccountObjectMother.generateBasicAccountDto();
        Mockito.when(accountService.getAccount(any(String.class), eq(id.toString())))
    ...
    void testGetAccountsForClient() throws Exception {
        ...
        Mockito.when(accountService.getAccountsForClient(any(String.class)))
            .thenReturn(accounts);
